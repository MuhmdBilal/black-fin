...
import urbanairporttransfers from "../../Assets/Honolulu-Airport.webp";
...
function HNL_Airport() {
  return (
    <div>
    <div className='backgroundiamge-hnl_airport'>
        <div className='back-color-one'>
            <div className='col-md-12'>
                <div>
                    <h4 className='FRANCISCO-h4'>HNL AIRPORT TRANSPORTATION</h4>
    ...
    <div className='container'>
        <div className='row d-flex justify-content-center'>
            <div className='col-11 text-center mt-5'>
                <h2 style={{ fontWeight: "600" }}>BOOK YOUR CAR SERVICE IN HONOLULU TODAY</h2>
                <h3 className='Private-h3'>Private airport transfers at Daniel K. Inouye International Airport (HNL) and transportation to all surrounding areas.</h3>
                <p className='Based-p mt-3 text-center'>Black Fin provides professional and streamlined airport car service in Honolulu and throughout Oahu. Our chauffeurs are required to be on location 10 minutes prior to the scheduled pickup, and with curbside access, direct driver communication and the option for baggage claim retrieval. Our goal is to ensure a stress-free ride whether you’re at the beginning or the end of your journey.</p>
    ...
    <div className='container'>
        <div className='row d-flex justify-content-center mt-5 mb-5'>
            ...
            <div className='col-lg-7 mt-5 text-md-start mb-5'>
                <img src={urbanairporttransfers} className='img-fluid' width="680px" />
            </div>
