...
import urbanairporttransfers from "../../Assets/urban-worldwide-reviews (1).webp";
    ...
    <div className='backgroundiamge-sanairport'>
        <div className='back-color-one'>
            <div className='col-md-12'>
                <div>
                    <h4 className='FRANCISCO-h4'>LAX AIRPORT TRANSPORTATION</h4>
    ...
    <div className='container'>
        <div className='row d-flex justify-content-center'>
            <div className='col-11 text-center mt-5'>
                <h2 style={{ fontWeight: "600" }}>BOOK YOUR LAX CAR SERVICE TODAY</h2>
                <h3 className='Private-h3'>Private airport transfers at Los Angeles International Airport and all surrounding areas.</h3>
                <p className='Based-p mt-3 text-center'>Black Fin offers the highest quality airport car service for those important and often time-sensitive trips to and from the airport. Our chauffeurs are required to be on location 10 minutes prior to the scheduled pickup, and with curbside access, direct driver communication and the option for baggage claim retrieval. Our goal is to ensure a stress-free ride whether you’re at the beginning or the end of your journey.</p>
    ...
    <div className='container'>
        <div className='row d-flex justify-content-center mt-5 mb-5'>
            ...
            <div className='col-lg-5 mb-5'>
                ...
                <div className="tab">
                    ...
                    <div className="tab-content text-start">
                        <p>Call and / or text the main Urban Worldwide office at +1 415 494 8122 and our team will immediately help you make the connection.</p>
                    </div>
                </div>
                <div className="tab">
                ...
                <div className="tab">
                    ...
                    <label className="tab-label text-start" for="chck4">What is the difference between curbside pick-up and drop-off, and baggage claim assistance?</label>
                    <div className="tab-content text-start">
            ...
            <div className='col-lg-7 mt-5 text-md-start mb-5'>
                <img src={urbanairporttransfers} className='img-fluid' width="580px" />
            </div>
